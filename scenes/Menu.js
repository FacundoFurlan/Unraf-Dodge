export default class Menu extends Phaser.Scene {
    ...
    create() {
      ...
      if (playerName) {
          ...
          const shopItems = [
            { id: 1, name: "Escudo", cost: 100, description: "Te protege del próximo hit" },
            { id: 2, name: "Congelar", cost: 150, description: "Automáticamente congela a los círculos durante 0.5s cada 5s" },
            { id: 3, name: "Velocidad", cost: 100, description: "Aumenta ligeramente la velocidad del cuadrado" },
            { id: 4, name: "Tamaño", cost: 100, description: "Reduce ligeramente el tamaño del cuadrado" },
            { id: 5, name: "Bomba", cost: 50, description: "Elimina todos los proyectiles del mapa" }
          ];
